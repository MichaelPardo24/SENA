    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-4 overflow-hidden sm:max-w-md sm:mx-auto sm:rounded-lg">
                ...
                <div class="mt-2 p-2">
                    <x-jet-danger-button class="px-1 flex-auto w-full" data-modal-toggle="popup-modal" data-id="{{ $fileType->id }}" >ELIMINAR</x-jet-danger-button>
                        ...
                        <div class="relative px-4 w-full max-w-md h-full md:h-auto">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-6 pt-0 text-center">
                                    ...
                                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-red-400">¿Esta seguro que quiere eliminar este tipo de archivo?</h3>
                                    <form action="{{ route('programs.destroy', $fileType->id) }}" method="POST" class="m-3">
                                        @method('DELETE')
                                        @csrf
