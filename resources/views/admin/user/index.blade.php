            ...
            <div class="flex flex-col justify-center">
                ...
                <div class="mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                    <header class="flex justify-between px-6 py-4 border-b border-gray-100">
                        ...
                        <a class="bg-orange-200 font-bold py-2 px-4 border border-orange-500 rounded hover:bg-orange-500 hover:text-white" href="{{ route('user.create') }}">CREATE</a>
                    </header>
                    <div class="p-3">
                        <div class="overflow-x-auto">
                                    <table class="table-auto w-full">
                                        ...
                                        <tr>
                                            ...
                                            <th class="whitespace-nowrap flex items-stretch">
                                        ...
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td class="p-2 whitespace-nowrap">
                                                    <div class="flex">
                                                        <a class="px-1 flex-auto" href="{{ route('user.show', $user->id) }}"><img src="https://img.icons8.com/ios-glyphs/30/000000/visible--v1.png"/></a>

                                                        <a class="px-1 flex-auto" href="{{ route('user.edit', $user->id) }}"><img src="https://img.icons8.com/ios-glyphs/30/000000/edit--v1.png"/></a>

                                                        <button class="px-1 flex-auto" data-modal-toggle="popup-modal" data-id="{{ $user->id }}" ><img src="https://img.icons8.com/ios-glyphs/30/000000/filled-trash.png"/></button>
