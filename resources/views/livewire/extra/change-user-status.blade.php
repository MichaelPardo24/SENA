<div>
    <span class="text-slate-700 text-sm italic tracking-wide font-bold">Estado: </span>
    @if($userStatus == "Certificado")
        <span class="text-slate-900 text-sm italic tracking-wide font-bold">CERTIFICADO</span>
    @else
