        ...
        <table class="table-auto w-full">
            ...
            <tbody class="text-sm divide-y divide-gray-100">
                @foreach ($programs as $program)
                    <tr>
                        <td class="p-2 whitespace-nowrap text-left font-bold text-gray-600">{{ $program->name}}</td>
                        <td class="p-2 whitespace-nowrap text-left font-medium text-gray-700">{{ $program->type}}</td>
                        <td class="p-2 whitespace-nowrap text-center font-medium text-gray-700">{{ $program->fichas_count}}</td>
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex">
                                <a class="px-1 flex-auto" href="{{ route('programs.show', $program->id) }}"><i class="fa-solid fa-eye fa-xl" style="color:orange"></i></a>

                                <a class="px-1 flex-auto" href="{{ route('programs.edit', $program->id) }}"><i class="fa-solid fa-user-pen fa-xl" style="color:orange"></i></a>

                                <button class="px-1 flex-auto" data-modal-toggle="popup-modal" data-id="{{ $program->id }}" ><i class="fa-solid fa-trash fa-xl" style="color:orange"></i></button>
