        ...
        @if (count($programs))
            <table class="table-auto w-full">
                <thead class="rounded-t-lg text-xs font-semibold uppercase text-white bg-orange-500">
                    <tr>
                        <th class="p-3 pl-6 whitespace-nowrap font-semibold text-left">Programa</th>
                ...
                <tbody class="text-sm divide-y divide-gray-100">
                    @foreach ($programs as $program)
                        <tr>
                            <td class="p-2 whitespace-nowrap text-left font-bold text-gray-800">{{ Str::limit($program->name, 50)}}</td>
                            <td class="p-2 px-5 whitespace-nowrap text-left font-semibold text-gray-700">{{ $program->type}}</td>
                            <td class="p-2 whitespace-nowrap text-center font-medium text-gray-700">{{ $program->fichas_count}}</td>
                            <td class="p-2 whitespace-nowrap">
                                <div class="flex">
                                    <a class="px-1 flex-auto" href="{{ route('programs.show', $program->id) }}"><i class="fa-solid fa-eye fa-xl" style="color:gray"></i></a>

                                    <a class="px-1 flex-auto" href="{{ route('programs.edit', $program->id) }}"><i class="fa-solid fa-user-pen fa-xl" style="color:gray"></i></a>

                                    <button class="px-1 flex-auto" data-modal-toggle="popup-modal" data-id="{{ $program->id }}" ><i class="fa-solid fa-trash fa-xl" style="color:red"></i></button>
                                        ...
                                        <div class="relative px-4 w-full max-w-md h-full md:h-auto">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-6 pt-0 text-center">
                                                    ...
                                                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Esta seguro que quiere eliminar este programa?</h3>
